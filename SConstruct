...
env.Command("walbrix", ["$SYSTEM_64_MARKER", "$SYSTEM_32_MARKER", "$WBUI_MARKER", "build/walbrix/locale", "build/walbrix/grubvars.cfg", "build/walbrix/grub.cfg","build/walbrix/install.cfg","build/walbrix/grub32.cfg"], "mksquashfs build/walbrix $TARGET -noappend")
