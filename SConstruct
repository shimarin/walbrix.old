...
env.Command("$DESKTOP_32_MARKER", ["source/desktop.i686","components/desktop.lst"], "rm -rf build/desktop/i686 && ./collect --source source/desktop.i686 --var=ARCH=i686 components/desktop.lst build/desktop/i686")
