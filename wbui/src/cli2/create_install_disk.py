...
GRUB_MODULES=["xfs","fat","ext2","part_gpt","part_msdos","normal","linux","echo","all_video","test","probe","multiboot","multiboot2","search","iso9660","gzio","lvm","chain","configfile","cpuid","minicmd","gfxterm","font","terminal","squash4","loopback","videoinfo","videotest","png","gfxterm_background"]
