...
GRUB_MODULES=["xfs","fat","part_gpt","part_msdos","normal","linux","echo","all_video","test","multiboot","multiboot2","search","iso9660","gzio","lvm","chain","configfile","cpuid","minicmd","gfxterm","font","terminal","squash4","loopback","videoinfo","videotest"]
...
def print_disk_info(disks):
    def size_to_str(size):
        ...
        #else
        return "%dTB" % (size / 1000000000)
    row_format ="{:>10} {:>8} {:>12} {:>20} {:>10}"
