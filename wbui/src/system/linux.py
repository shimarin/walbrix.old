...
class System:
    ...
    def installGrubEFI(self, targetDir):
        ...
        self.execShell("grub-mkimage -o %s/EFI/BOOT/bootx64.efi -O x86_64-efi xfs fat ext2 part_gpt part_msdos normal linux echo all_video test probe multiboot multiboot2 search iso9660 gzio lvm chain configfile cpuid minicmd gfxterm font terminal" % targetDir)
